...
namespace biblioteca.Controllers
{
    public class LibrariansController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var librarian = await _context.Bibliotecarios
        ...
        public async Task<IActionResult> Create([Bind("Id,lName,lAddress,mobileNo")] Librarian librarian)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var librarian = await _context.Bibliotecarios.FindAsync(id);
            if (librarian == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,lName,lAddress,mobileNo")] Librarian librarian)
        {
            if (id != librarian.Id)
            {
                return NotFound();
        ...
        {
            var librarian = await _context.Bibliotecarios.FindAsync(id);
            _context.Bibliotecarios.Remove(librarian);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
